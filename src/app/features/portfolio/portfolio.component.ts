...
export class PortfolioComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  projects: Project[] = [
    ...
    },
    {
      ...
      categoryKey: "PORTFOLIO.CATEGORIES.AUTOMATION",
      year: "2026",
      videoUrl: "assets/videos/leadgen_extraction_4K.mp4",
    ...
    },
    {
      ...
      categoryKey: "PORTFOLIO.CATEGORIES.AUTOMATION",
      year: "2026",
      videoUrl: "assets/videos/ai_support_hub_4K.mp4",
    ...
    },
    {
      ...
      categoryKey: "PORTFOLIO.CATEGORIES.AUTOMATION",
      year: "2026",
      videoUrl: "assets/videos/Meridian_Finance_Report_4K.mp4",
    ...
    },
    {
      ...
      year: "2026",
      videoUrl: "assets/videos/auditAIO.mp4",
