 ...
 * El sitio es INGLÉS por defecto (idioma master): la raíz (/) es inglés y el
 * español vive en /es. Lee la ruta con PlatformLocation (no con el global
 * `location`), para que FUNCIONE también durante el prerender: así / genera HTML
 * en inglés y /es en español, en vez de quedarse siempre en el mismo idioma.
 */
